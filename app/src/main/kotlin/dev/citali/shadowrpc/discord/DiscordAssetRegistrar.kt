...
object DiscordAssetRegistrar {
    ...
    /** Application whose external-assets endpoint is used. Set by the presence manager. */
    @Volatile var applicationId: String = "0"
    ...
    private fun registerExternal(
        ...
        val request =
            Request
                .Builder()
                .url("$API_BASE/applications/$applicationId/external-assets")
